        ...
        <script>
            ...
            const confirmPassword = () => {
                ...
                if (document.getElementById("pass").value === document.getElementById("repass").value
                        && checkRegex('pass', 'errPwd', /(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[A-Za-z\d]{6,}/g, 'Password must contains at least 1 upper, 1 lower and more than 6 letters!') === true)
                    return true;
                document.getElementById("errPwd").innerHTML = "Password not match/ invalid!";
                return false;
            };
